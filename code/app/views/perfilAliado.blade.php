	        		...
	        		<div class="col-md-12">
	        			<div class="header-profile">
		        			<div class="user-data">
			                    ...
			                    <h1 class="name">H. Ayuntamiento de Mazatl&aacute;n</h1>
                                <div class="controls">
                                    <a>
                                    	<i class="fa fa-user"></i> Aliado Master
                                    </a>
                                </div>
	                            <div class="stats">
          ...
          <div class="row">
            ...
            <div class="col-md-8 col-sm-8 blog-item">
                <div class="form-group">
                    ...
                    <div class="col-lg-8">
                      <label for="email" class="control-label">Nombre del Aliado (Osea empresa)</label>
                    </div>
                  </div>
                  <div class="form-group">
			...
			<div class="col-md-12">
				<div class="form-info logros-reconocimientos">
					<h2>
						...
						<em>Evento Fulanito</em> <button data-func="hideAccordion" data-accordion="accordion1" type="button" class="btn btn-default pull-right">Ocultar Actividades</button>
					</h2>
				</div>
				...
				<div class="form-info logros-reconocimientos">
					<h2>
						<img width="50" height="50" src="https://s3-eu-west-1.amazonaws.com/web-lvp-prod/avatar/0001/01/thumb_94_avatar_normal.jpeg">
						<em>Evento Fulanito 2</em> <button data-func="showAccordion" data-accordion="accordion2" type="button" class="btn btn-info pull-right">Mostrar Actividades</button>
					</h2>
				</div>
				...
				<div class="form-info logros-reconocimientos">
					<h2>
						<img width="50" height="50" src="https://s3-eu-west-1.amazonaws.com/web-lvp-prod/avatar/0001/01/thumb_94_avatar_normal.jpeg">
						<em>Evento Fulanito 3</em> <button data-func="showAccordion" data-accordion="accordion3" type="button" class="btn btn-info pull-right">Mostrar Actividades</button>
					</h2>
				</div>
