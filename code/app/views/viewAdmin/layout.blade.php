...
<head>
<meta charset="utf-8">
<title>Voluntarios | Admin Panel</title>
	...
	<div class="page-header-menu">
		<div class="container">
			...
			<div class="hor-menu ">
				<ul class="nav navbar-nav">
					<li class="">
						<a href="{{ route('adminIndex') }}">Novedades</a>
					</li>
					<li class="">
						<a href="{{ route('adminDependencia') }}">Dependencias</a>
					</li>
					<li class="">
						<a href="{{ route('adminConfig') }}">Configuraciones</a>
					</li>
					<li class="">
						<a href="{{ route('adminPerfil') }}">Perfil</a>
					</li>
					<li class="">
						<a href="{{ route('adminFAQ') }}">Ayuda</a>
					</li>
				</ul>
			</div>
			<!-- END MEGA MENU -->
