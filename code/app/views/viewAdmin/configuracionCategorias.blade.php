								...
								<div class="portlet light">
									<div class="portlet-title tabbable-line">
										<div class="caption caption-md">
											...
											<span class="caption-subject font-blue-madison bold uppercase">Categorias de la Plataforma</span>
										</div>
										<ul class="nav nav-tabs">
											...
											<li>
												<a href="#tab_1_2" data-toggle="tab">Nueva</a>
											</li>
										</ul>
									</div>
										...
										<div class="tab-content">
											...
											<div class="tab-pane active" id="tab_1_1">
												<table class="table table-striped table-hover table-bordered" id="basicTable_vol">
													...
													<thead id="filtros">
							                            <tr>
							                                <th><input type="text" id="i-0" class="search_init" style="display: none;"></th>
							                                <th><input type="text" id="i-1" class="search_init" style="width:100%;"></th>
							                                <th><input type="text" id="i-2" class="search_init"  style="width:100%;"></th>
													...
													<tr>
														<td>
															 <img src="{{ $categoria->imagen }}/?{{ rand(1,100) }}" alt="{{ $categoria->nombre }}" />
														</td>
														<td>
															 {{ $categoria->nombre }}
														</td>
														<td>
                                                                                                                     {{ $categoria->actividades->count() }}
											...
											<div class="tab-pane" id="tab_1_2">
												<form role="form" action="#">
													<div class="form-group">
														...
														<option rel="fa-glass">Mustard</option>
														<option rel="fa-heart">Ketchup</option>
														<option rel="fa-film">Relish</option>
														<option rel="fa-home">Mayonnaise</option>
														<option rel="fa-user">Barbecue Sauce</option>
													</select>
													</div>
													<div class="form-group">
