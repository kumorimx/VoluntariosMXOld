...
<head>
<meta charset="utf-8">
<title>Voluntarios | Panel Dependencia</title>
	...
	<div class="page-header-menu">
		<div class="container">
			...
			<div class="hor-menu ">
				<ul class="nav navbar-nav">
					<li class="">
						<a href="{{ route('depIndex') }}">Novedades</a>
					</li>
					<li class="">
						<a href="{{ route('depProyectos') }}">Proyectos</a>
					</li>
					<li class="">
						<a href="{{ route('depAliados') }}">Aliados</a>
					</li>
					<li class="">
						<a href="{{ route('depConfigs') }}">Configuraciones</a>
					</li>
					<li class="">
						<a href="{{ route('depPerfil') }}">Perfil</a>
					</li>
					<li class="">
						<a href="{{ route('depFAQ') }}">Ayuda</a>
					</li>
				</ul>
			</div>
			<!-- END MEGA MENU -->
